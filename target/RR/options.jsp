...
if(usertype.equals("hr")||usertype.equals("sysadmin"))
{
%>
<br>
...
<form  action= "ViewChanges" method="post">
    <button type="submit" value="view the request database">view the audit trail</button>
</form><br>
<%}%>
