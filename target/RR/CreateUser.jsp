...
<body>
    	...
    	<div class="any" style="max-width:60%">
	     <div class="form">
        <div class="formtext">Enter Credentials</div>
       <div class="forminput">
        <form action="NewUser" method="post">
		<div class="options">Enter Username:<input type="text" name="uid" autofocus required></div><br>
		<div class="options">Enter password:<input type="password" name="pass" required ></div><br>
		<div class="options">Select Usertype:<br><select  name= "Usertype">
